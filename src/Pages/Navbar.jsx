...
function Navbar() {
    ...
    return <Box data-testid="nav-menu" zIndex={1} color={isscroll ? darkTheme === "dark" ? "white" : "white" : darkTheme === "dark" ? "white" : "white"} bg={isscroll ? darkTheme === "dark" ? "#48B3E9 " : "#48B3E9 " : darkTheme === "dark" ? "#1D2143" : "#1D2143"} w="100%" p="11px 9px" boxShadow="md" position="fixed">
