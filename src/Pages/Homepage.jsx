            ...
            <Box h="574px" w="85%" color={darkTheme === "dark" ? "#d3cedb" : "#13022C"} m="auto" display={["inline", "inline", "flex"]} alignItems="center" justifyContent="space-around">
                <Box mt={["50px", "50px", "0px"]} w={["100%", "100%", "60%"]}>
                    <Box textAlign="left" m="auto" pl={["20px", "60px", "20px"]}>
                        ...
                        <Button id="resume-link-2" _hover={{ transform: "scale(1.1)", bg: "#92bcb5", color: darkTheme === "dark" ? "black" : "black" }} mt="10px" p={["15px 15px", "20px 20px", "25px 25px"]} onClick={handleClick} fontSize={["md", "lg", "xl"]} bg={darkTheme === "dark" ? "#48B3E9 " : "#48B3E9 "} color={darkTheme === "dark" ? "white" : "white"} variant='solid' leftIcon={<DownloadIcon />}>
